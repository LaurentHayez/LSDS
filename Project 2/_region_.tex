\message{ !name(LSDS_project2_hayezl.tex)}\documentclass[a4paper, 11pt]{article}
...
\message{ !name(LSDS_project2_hayezl.tex) !offset(-3) }
...
%%% TeX-master: t 
%%% End:
\message{ !name(LSDS_project2_hayezl.tex) !offset(-308) }
