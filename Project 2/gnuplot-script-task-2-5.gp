...
set output "plots/task2-5-cluster.pdf"
set title "Search performance in Chord with a finger table"
...
plot 'ParsedLogs/log-task2-5-cluster.txt' using 2:xtic(5)  title 'number of keys found in x hops'
