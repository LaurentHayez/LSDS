...
set output "plots/task3-5-cluster.pdf"
set title "Search performance in Chord with churn"
...
plot 'ParsedLogs/log-task3-5-cluster.txt' using 2:xtic(5)  title 'number of keys found in x hops'
