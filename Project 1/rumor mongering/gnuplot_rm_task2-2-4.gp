...
set output "rm_plot_task2-2-4.pdf"
set title "Comparison of anti-entropy and rumor mongering"
...
plot "parsed_log_rm_ae_style/parsed_log_htl2_f3.txt" u ($1):(100*$3) with lines linestyle 1 title "HTL=2, f=3",\
     "parsed_log_rm_ae_style/parsed_log_htl3_f2.txt" u ($1):(100*$3) with lines linestyle 2 title "HTL=3, f=2",\
     "parsed_log_rm_ae_style/parsed_log_htl5_f2.txt" u ($1):(100*$3) with lines linestyle 3 title "HTL=5, f=2",\
     "parsed_log_rm_ae_style/parsed_log_htl5_f5.txt" u ($1):(100*$3) with lines linestyle 4 title "HTL=5, f=5",\
     "parsed_log_rm_ae_style/parsed_log_htl5_f8.txt" u ($1):(100*$3) with lines linestyle 5 title "HTL=5, f=8",\
     "../antientropy/parsed_text_file.txt" u ($1):(100*$3) with lines linestyle 6 title "anti-entropy"
