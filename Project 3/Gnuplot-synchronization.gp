...
set title "Synchronization for the adaptive Ermentrout model (75 nodes, delta = 2, epsilon=0.01)"
...
set yrange [0:82] # example of a closed range (points outside will not be displayed)
