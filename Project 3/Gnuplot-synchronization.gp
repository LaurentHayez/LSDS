...
set title "Synchronization for the adaptive Ermentrout model (64 nodes, delta = 5)"
...
set xrange [0:300] # example of a range closed on one side only, the max will determined automatically
