...
set title "Cycle lengths for the adaptive Ermentrout model under churn (64 nodes, delta = 5)"

# indicates the labels
set ylabel "Cycle length (s)"
set xlabel "Time (s)"
...
set yrange [0:10] # example of a closed range (points outside will not be displayed)
set xrange [0:] # example of a range closed on one side only, the max will determined automatically

set pointsize 0.1

plot datafile u ($1):($2) with points ls 2 pt 6 title "Cycle lengths"
